<%-- 
    Document   : view_won_statistics_outcome
    Created on : 21 May 2026, 11:48:55 PM
    Author     : Ryan
--%>
...
<html>
    <head>
        ...
        <title>View Won Statistics Outcome Page</title>
    </head>
    <body>
        <h1>View Won Statistics Outcome</h1>
        <%
        ...
        %>
        <p>
            <b><%=nameSess%></b>, <b><%=compName%></b> provided you with a list of all the won game statistics below:
        </p>
        <table border='1'>
        <%
